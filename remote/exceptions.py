...
class InvalidInputError(RemotePyError):
    ...
    def __init__(
        self, parameter_name: str, value: str, expected_format: str, details: str | None = None
    ):
...
class AWSServiceError(RemotePyError):
    ...
    def _get_user_friendly_message(self, error_code: str, original_message: str) -> str:
        ...
        error_mappings = {
            ...
            "DryRunOperation": ("This was a dry run operation. No actual changes were made."),
            ...
            "InvalidParameterValue": ("One of the provided parameters has an invalid value."),
